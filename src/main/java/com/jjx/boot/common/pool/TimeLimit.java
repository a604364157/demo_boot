package com.jjx.boot.common.pool;
...
public class TimeLimit {
    ...
    private final Logger log = LoggerFactory.getLogger(TimeLimit.class);
    private final WebApplicationContext wac = ContextLoader.getCurrentWebApplicationContext();

    private final ThreadPoolTaskScheduler scheduler = ThreadPoolSingle.getSingle().getScheduler();
    private final ExecutorService executorService = ThreadPoolSingle.getSingle().getThreadPool();
    private final ScheduledExecutorService executor = ThreadPoolSingle.getSingle().getService();
    ...
    private void test9(List<String> list) {
        list.sort((o1, o2) -> {
            ...
            return Integer.parseInt(ot1) - Integer.parseInt(ot2);
        });
    }
